...
func makeProviderCmd() *cobra.Command {
	...
	command.RunE = func(_ *cobra.Command, _ []string) error {
		...
		bootstrapHandlers := types.FaaSHandlers{
			...
			FunctionReader:       handlers.MakeReadHandler(client, *config, invokeResolver),
			ReplicaReader:        handlers.MakeReplicaReaderHandler(client, *config, invokeResolver),
			ReplicaUpdater:       handlers.MakeReplicaUpdateHandler(client, cni, *config, invokeResolver),
